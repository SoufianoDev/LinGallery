...
private var _MobileBlock: ImageVector? = null

val MobileBlock: ImageVector
    get() {
        if (_MobileBlock != null) return _MobileBlock!!
        _MobileBlock = ImageVector.Builder(
            name = "mobile_block",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 960f,
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                quadToRelative(-11f, 6f, -22.5f, 9f)
